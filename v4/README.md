...
- **レッスン2**: K M（2文字目まで）
- **レッスン3**: K M U（3文字目まで）
- **レッスン4〜10**: 順次1文字ずつ追加（R, E, S, N, A, P, T）
- **レッスン11〜20**: 順次1文字ずつ追加（L, W, I, ., J, Z, =, F, O, Y）
- **レッスン21〜30**: 順次1文字ずつ追加（,, V, G, 5, /, Q, 9, 2, H, 3）
- **レッスン31〜40**: 順次1文字ずつ追加（8, B, ?, 4, 7, C, 1, D, 6, 0）
- **レッスン41**: 全41文字完了（最後にXを追加）

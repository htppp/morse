import{A as m,M as g}from"./audio-system-IwvVicxu.js";import{e as u}from"./index-B3-VcTss.js";class w{constructor(){this.entries=[],this.filteredEntries=[],this.selectedTags=new Set,this.selectedFrequencies=new Set([5]),this.displayMode="card",this.viewMode="browse",this.sortColumn="abbreviation",this.sortDirection="asc",this.searchQuery="",this.currentCards=[],this.currentIndex=0,this.isFlipped=!1,this.progress={known:new Set,unknown:new Set},this.reviewMode=!1,this.hideAbbreviation=!1,this.isLearning=!1,this.learnQuestionType="abbr-to-meaning",this.currentlyPlaying=null,this.examQuestions=[],this.currentQuestionIndex=0,this.examResults=[],this.questionCount=10,this.questionType="abbr-to-meaning",this.settingsModalOpen=!1,this.tempSettings=null,this.isTestPlaying=!1,this.audioSystem=new m,this.loadProgress(),this.loadFilters(),this.loadViewState(),this.loadData()}loadViewState(){try{const t=localStorage.getItem("v8.flashcard.viewMode");t&&["browse","learn","exam"].includes(t)&&(this.viewMode=t);const e=localStorage.getItem("v8.flashcard.learnQuestionType");e&&["abbr-to-meaning","meaning-to-abbr","morse-to-abbr","morse-to-meaning"].includes(e)&&(this.learnQuestionType=e);const s=localStorage.getItem("v8.flashcard.questionType");s&&["abbr-to-meaning","meaning-to-abbr","morse-to-abbr","morse-to-meaning"].includes(s)&&(this.questionType=s)}catch(t){console.error("Failed to load view state:",t)}}saveViewMode(){try{localStorage.setItem("v8.flashcard.viewMode",this.viewMode)}catch(t){console.error("Failed to save view mode:",t)}}saveLearnQuestionType(){try{localStorage.setItem("v8.flashcard.learnQuestionType",this.learnQuestionType)}catch(t){console.error("Failed to save learn question type:",t)}}saveExamQuestionType(){try{localStorage.setItem("v8.flashcard.questionType",this.questionType)}catch(t){console.error("Failed to save exam question type:",t)}}async loadData(){try{const t=await fetch("./flashcard.tsv");if(!t.ok)throw new Error(`HTTP error! status: ${t.status}`);const e=await t.text();this.entries=e.trim().split(`
